      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form class="mb-6" action="{{ route('profile.store') }}" method="POST">
            ...
            <div class="flex flex-col mb-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="birthday">生年月日<span class="text-red-500">（非公開）</span></label>
              <input class="border py-2 px-3 text-grey-darkest" type="date" name="birthday" id="birthday">
            </div>
            <div class="flex flex-col mb-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="school">学校名<span class="text-red-500">（非公開）</span></label>
              <input class="border py-2 px-3 text-grey-darkest" type="text" name="school" id="school">
            </div>
            <div class="flex flex-col mb-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="grade">現在の学年（公開されます）</label>
